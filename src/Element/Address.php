...
class Address extends FormElement {
	...
	protected static function addressElements(array $element, array $value) {
		...
		if (isset($element['organization'])) {
			$element['organization']['#weight'] = '1';
		}
		if (isset($element['container5'])) {
			$element['container5']['#weight'] = '2';
		}
		if (isset($element['postal_code'])) {
			$element['postal_code']['#weight'] = '3';
		}
		if (isset($element['container1'])) {
			$element['container1']['#weight'] = '4';
		}
		if (isset($element['address_line1'])) {
			$element['address_line1']['#weight'] = '6';
		}
		if (isset($element['address_line2'])) {
			$element['address_line2']['#title_display'] = 'invisible';
			$element['address_line2']['#weight'] = '7';
